...
function getDirectoryContents(remotePath, options) {
   ...
   // My logs
	console.log('The requested URL is :  ', requestOptions.url);
    let response = null;
    prepareRequestOptions(requestOptions, options);
	//console.log('Request options are ..   ', requestOptions);
	//console.log('options are ..  ',options);
	//console.log('handle response code .. ', handleResponseCode);
    return request(requestOptions).then(handleResponseCode).then(res => {
	//console.log('Inside the return statement of requestOptions that calls file');
        response = res;
        return res.data;
...
function getDirectoryFiles(result, serverBasePath, requestPath, isDetailed = false) {
	...
	//My logs
	//console.log('Server Base Path ..  ', serverBasePath );
	//console.log('Server Base after appending a slash ..  ', serverBase );
	//console.log('Request Path ..  ', requestPath );
	//console.log('Remote Target Path (adds serverbasepath , request path and a slash) ..  ', remoteTargetPath);
