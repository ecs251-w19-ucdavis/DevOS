...
var _require2 = require("./patcher.js");
...
function prepareRequestOptions(requestOptions, methodOptions) {
	//My LOGS
	//console.log('Inside preparerequestoption');
	//console.log('Agent being used .. ', methodOptions);
    if (methodOptions.httpAgent) {
        requestOptions.httpAgent = methodOptions.httpAgent;
	//console.log('httpAgent', methodOptions.httpAgent);
    }
    if (methodOptions.httpsAgent) {
        requestOptions.httpsAgent = methodOptions.httpsAgent;
	//console.log('httpsAgent', methodOptions.httpsAgent);
    }
...
function request(requestOptions) {
	//console.log('Freaking request function');
	//console.log('printing axios options value  ',axios(requestOptions));
    return getPatcher().patchInline("request", options => axios(requestOptions), requestOptions);
}
